...
DOCK_REPOSITORY=jdk7

fileurl=${FILE_SERVER}/deploy/baseprogram/jdk/jdk-7u55-linux-x64.gz
file=${SELF_BASE}/resource/jdk-7u55-linux-x64.gz
filemd5="9e1fb7936f0e5aaa1e64d36ba640bc1f"
